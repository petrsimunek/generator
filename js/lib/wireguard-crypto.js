 ...
 *
 * Curve25519 helpers adapted from wireguard-tools contrib/keygen-html/wireguard.js
 * for browser-side WireGuard key generation compatible with `wg genkey` / `wg pubkey`.
 */
...
function generatePrivateKeyBytes() {
...
export function generateKeypair() {
  ...
  return {
    privateKey: keyToBase64(privateKeyBytes),
    publicKey: keyToBase64(publicKeyBytes),
  };
}
